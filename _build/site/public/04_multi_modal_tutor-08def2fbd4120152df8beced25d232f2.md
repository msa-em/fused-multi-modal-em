...
Try changing lambda parameters to see how convergence is effected.  Notice how by changing the lambdaChem parameter, the cost function oscillates preventing convergence.
```
